...
<main class="container">
    <main class="container">
        <!-- leads table -->
        <h2 class="display-4 page-header">Manage Clients</h2>
        <p>You can edit clients by clicking the edit icon.</p>
        <p>Add user using the Add user button, Search for clients using the search bar</p>
        <div class="row">
...
function fetchRecords($records)
{
    ...
    foreach ($records as $record) {
        ...
        <td scope='col'>{$record['contact_name']}</td>
